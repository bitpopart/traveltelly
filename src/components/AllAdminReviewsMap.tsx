...
const createCustomIcon = (rating: number, precision?: number, upgraded?: boolean, gpsCorreected?: boolean, type?: 'review' | 'stock-media' | 'story') => {
  ...
  try {
    ...
    const fallbackSvg = `<svg viewBox="0 0 72.61 100.72" xmlns="http://www.w3.org/2000/svg"><path d="M36.31,0C15.67,0,0,18.32,0,37.04c0,14.93,36.31,63.67,36.31,63.67,0,0,36.3-48.74,36.3-63.67C72.61,18.32,56.94,0,36.31,0Z" fill="${markerBaseColor}"/><circle cx="36.31" cy="36.44" r="19.75" fill="white"/></svg>`;
    return new Icon({
