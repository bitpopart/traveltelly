...
import { Shield, QrCode, Smartphone, AlertCircle, ExternalLink, Lock, X } from 'lucide-react';
...
const LoginDialog: React.FC<LoginDialogProps> = ({ isOpen, onClose, onLogin, onSignup }) => {
  ...
  const loginContent = (
    <div className='space-y-5'>
      ...
      {/* Footer */}
      <div className='text-center text-sm space-y-1.5 pb-2'>
  ...
  // ── Mobile: render as bottom Drawer (swipe-to-dismiss, scrollable) ─────────
  if (isMobile) {
    return (
